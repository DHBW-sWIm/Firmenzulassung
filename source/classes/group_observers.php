    ...
    public static function dual_partner_added(\core\event\user_enrolment_created $event) {
        ...
        if(date("n") < $start && date("n") > $end ){
            ...
            */
            ...
            $emailText = get_string('notifyemailnewdualpartner_partner', 'firmenzulassung', format_string(fullname($enrolledUser))); //email content
        }else{
            /*
            ...
            */
            ...
            $emailText = get_string('notifyemailnewdualpartner_studiengangsleiter', 'firmenzulassung', $data); //email content
        }       
