...
class Uebersicht extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addGroup([$mform->createElement('html', '<text style="color: rgb(250, 70, 50); font-weight:  bold;">' . get_string('status' . $dbConnectivity->getCurrentStatus($anfrage_id), 'mod_apsechs') . '</text>')],
                         'status', get_string('status', 'mod_apsechs'), array(' '), false);
        $mform->addElement('static', 'requestDate', get_string('antragsdatum', 'mod_apsechs'), $dbConnectivity->getRequestDate($anfrage_id));
        ...
        $mform->addElement('static', 'vorname', get_string('vorname', 'mod_apsechs'), $dbConnectivity->getMetaData($anfrage_id)["angesteller"]["vorname"]);
        $mform->addElement('static', 'nachname', get_string('nachname', 'mod_apsechs'), $dbConnectivity->getMetaData($anfrage_id)["angesteller"]["nachname"]);        
        $mform->addElement('static', 'email', get_string('email', 'mod_apsechs'), $dbConnectivity->getMetaData($anfrage_id)["angesteller"]["email"]);
        $mform->addElement('static', 'tel', get_string('tel', 'mod_apsechs'), $dbConnectivity->getMetaData($anfrage_id)["angesteller"]["tel"]);
        $mform->addElement('static', 'fax', get_string('fax', 'mod_apsechs'), $dbConnectivity->getMetaData($anfrage_id)["angesteller"]["fax"]);        
        ...
        $mform->addElement('static', 'name', get_string('name', 'mod_apsechs'), $dbConnectivity->getMetaData($anfrage_id)["unternehmen"]["name"]);
        $mform->addElement('html', '</td></tr><tr><td colspan=2>');
        $mform->addElement('static', 'branche', get_string('branche', 'mod_apsechs'), $dbConnectivity->getMetaData($anfrage_id)["unternehmen"]["branche"]);        
        $mform->addElement('html', '</td></tr><tr><td>');
        $mform->addElement('static', 'mitgliedKammer', get_string('mitgliedKammer', 'mod_apsechs'), $dbConnectivity->getMetaData($anfrage_id)["unternehmen"]["mitgliedKammer"]);        
        $mform->addElement('html', '</td><td>');
        $mform->addElement('static', 'in', get_string('in', 'mod_apsechs'), $dbConnectivity->getMetaData($anfrage_id)["unternehmen"]["in"]);        
        $mform->addElement('html', '</td></tr><tr><td>');
        $mform->addElement('static', 'anzahlMitarbeiter', get_string('anzahlMitarbeiter', 'mod_apsechs'), $dbConnectivity->getMetaData($anfrage_id)["unternehmen"]["anzahlMitarbeiter"]);        
        $mform->addElement('html', '</td><td>');
        $mform->addElement('static', 'anzahlKaufmAusbildenden', get_string('anzahlKaufmAusb', 'mod_apsechs'), $dbConnectivity->getMetaData($anfrage_id)["unternehmen"]["anzahlKaufmAusbildenden"]);        
        $mform->addElement('html', '</td></tr><tr><td>');
        $mform->addElement('static', 'anzahlTechnischenAusbildenden', get_string('anzahlTechnischenAusb', 'mod_apsechs'), $dbConnectivity->getMetaData($anfrage_id)["unternehmen"]["anzahlTechnischenAusbildenden"]);        
        $mform->addElement('html', '</td><td>');
        $mform->addElement('static', 'anzahlSonstigerAusbildenden', get_string('anzahlSonstigerAusb', 'mod_apsechs'), $dbConnectivity->getMetaData($anfrage_id)["unternehmen"]["anzahlSonstigerAusbildenden"]);        
        $mform->addElement('html', '</td></tr><tr><td>');
        $mform->addElement('static', 'stadt', get_string('stadt', 'mod_apsechs'), $dbConnectivity->getMetaData($anfrage_id)["unternehmen"]["stadt"]);
        $mform->addElement('html', '</td><td>');
        $mform->addElement('static', 'postleitzahl', get_string('postleitzahl', 'mod_apsechs'), $dbConnectivity->getMetaData($anfrage_id)["unternehmen"]["postleitzahl"]);
        $mform->addElement('html', '</td></tr><tr><td>');
        $mform->addElement('static', 'strasse', get_string('strasse', 'mod_apsechs'), $dbConnectivity->getMetaData($anfrage_id)["unternehmen"]["strasse"]);
        $mform->addElement('html', '</td><td>');
        $mform->addElement('static', 'nummer', get_string('nummer', 'mod_apsechs'), $dbConnectivity->getMetaData($anfrage_id)["unternehmen"]["nummer"]);
        ...
        $mform->addElement('static', 'verguetung', get_string('verguetung', 'mod_apsechs'), $dbConnectivity->getMetaData($anfrage_id)["ausbildung"]["verguetung"]);
