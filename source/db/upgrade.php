...
/**
 * This file keeps track of upgrades to the apsechs module
 *
...
/**
 * Execute apsechs upgrade from the given old version
 *
 * @param int $oldversion
 * @return bool
 */
function xmldb_firmenzulassung_upgrade($oldversion) {
    global $DB;
     ...
     * for demonstrative purposes and to show how the apsechs
     * iself has been upgraded.
     *
     * For each upgrade block, the file apsechs/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to apsechs.
        $table = new xmldb_table('apsechs');
        ...
        // Define field intro to be added to apsechs.
        $table = new xmldb_table('apsechs');
        ...
        // Define field introformat to be added to apsechs.
        $table = new xmldb_table('apsechs');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'apsechs');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to apsechs.
        $table = new xmldb_table('apsechs');
        ...
        // Define field timemodified to be added to apsechs.
        $table = new xmldb_table('apsechs');
        ...
        // Define index course (not unique) to be added to apsechs.
        $table = new xmldb_table('apsechs');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'apsechs');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'apsechs');
    }
    ...
    if ($oldversion < 2018070700) {
        ...
        $table = new xmldb_table('firmenzulassung_antraege');
