...
/**
 * Internal library of functions for module apeins
 *
 * All the apeins specific functions, needed to implement the module
...
function apeins_do_something_useful(array $things) {
    return new stdClass();
}

function apeins_get_process_definition_id($processKey) {
	global $processDefinitionsApiInstance;
...
function apeins_start_process($process_definition_id, $business_key) {
	global $processInstancesApiInstance;
...
function apeins_check_for_input_required($process_instance_id) {
	global $tasksApiInstance;
	try {
...
function apeins_answer_input_required($task_id, $process_definition_id, $value1, $value2) {
	global $formsApiInstance;
...
function apeins_get_process_instance_status($process_instance_id) {
	global $processInstancesApiInstance;
